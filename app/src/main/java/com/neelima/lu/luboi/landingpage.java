    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        compscience.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             startActivity(new Intent(getApplicationContext(),semesterview.class).putExtra("course","Department of CSE").setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        });
        bece.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),semesterview.class).putExtra("course","Department of EEE").setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        });
        bmech.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),semesterview.class).putExtra("course","Department of English").setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        });
        bcivil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),semesterview.class).putExtra("course","Department of Civil").setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        });
        bscience.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),semesterview.class).putExtra("course","Department of Law").setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        });
        bcommerce.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),semesterview.class).putExtra("course","Department of BBA").setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
            }
        });
    }
